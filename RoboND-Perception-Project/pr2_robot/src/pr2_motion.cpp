    ...
    left_gripper_group(LEFT_GRIPPER_GROUP)
{
  ...
  bool right_success = (bool)right_move_group.move();
  bool left_success = (bool)left_move_group.move();
  ...
  for(size_t i=0; i<pose_list.size();++i)
  {
    ...
    right_success = (bool)right_move_group.plan(right_arm_plan);
  ...
  right_move_group.setNamedTarget("RIGHT_ARM_INITIAL_POSE");
  left_move_group.setNamedTarget("LEFT_ARM_INITIAL_POSE");
  right_success = (bool)right_move_group.move();
  left_success = (bool)left_move_group.move();
}
...
bool PR2Motion::OperateRightGripper(const bool &close_gripper)
{
  ...
  bool success = (bool)right_gripper_group.move();
  return success;
}
...
bool PR2Motion::OperateLeftGripper(const bool &close_gripper)
{
  ...
  bool success = (bool)left_gripper_group.move();
  return success;
}
